<template>
  ...
  <div class="about">
    <div style="margin-top: 32px; font-size: 14px;">
      ...
      <div> 3. 追光迷影功能内, 请不要将未上映或距离资源发布较早的内容添加进每日刷新的豆瓣账户内, 尽量区分不同上映时间的电影或剧集, 分别给他们不同的刷新周期</div>
      <div style="padding-bottom: 8px;"></div>
      <div>同时, 希望您不要在各大公开社交媒体平台宣传或提及本软件, 社交平台包括但不限于 B 站 / 快手 / 抖音 / 百度贴吧(除 PT 吧) 等</div>
